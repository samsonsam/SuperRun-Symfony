 ...
 */
class Version20171219002052 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('DROP TABLE my_user_entity');
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE my_user_entity (id INTEGER NOT NULL, name VARCHAR(255) NOT NULL COLLATE BINARY, roles CLOB NOT NULL COLLATE BINARY --(DC2Type:array)
        , password VARCHAR(64) NOT NULL COLLATE BINARY, PRIMARY KEY(id))');
